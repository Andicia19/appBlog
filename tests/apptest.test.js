...
describe("favorite blog", () => {
  ...
  test("when list has many blog, the favorite blog is", () => {
    const result = listHelper.favoriteBlog(blogs);
    assert.deepStrictEqual(result, maxBlog);
  });
});

describe("Count Blogger", () => {
  mostBlog = {
    author: "Robert C. Martin",
    blogs: 3,
  };
  test("when list has many blog, the author with the most blogs is", () => {
...
describe("author with the most likes", () => {
  ...
  test("when list has many blog, the authors with most likes is", () => {
